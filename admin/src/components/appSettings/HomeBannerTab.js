...
const HomeBannerTab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <>
      {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[values][home_banner][banners]", [...values['values']['home_banner']['banners'], { title: "", description: "", status: false }])} title="add_banners" />}
      {
