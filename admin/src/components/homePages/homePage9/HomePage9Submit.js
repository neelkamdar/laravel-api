...
const HomePage9Submit = (values, mutate) => {
    ...
    if (values['homeBanner9Image']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeBanner9Image'].hasOwnProperty('asset_url') ? values['homeBanner9Image']?.asset_url : values['homeBanner9Image']?.original_url
