...
class RefundRepository extends BaseRepository
{
    ...
    {
        return $this->product->where('id', $product_id)?->value('is_return');
    }
    ...
    public function verifyStatus($order)
    {
        ...
        throw new Exception(__('errors.refund_for_completed_delivered_order'), 400);
    }
    ...
    public function verifyRefund($consumer_id, $request)
    {
        ...
        throw new Exception(__('errors.refund_feature_disabled'), 400);
    }
    ...
    public function verifyPaymentAccount($user_id)
    {
        ...
        throw new Exception(__('errors.payment_account_before_refund'), 400);
    }
    ...
    public function isNotAlreadyRequest($consumer_id, $product_id, $order_id)
    {
        ...
        throw new Exception(__('errors.refund_already_submitted'), 400);
    }
    ...
    public function verifyDeliveryDays($order, $refundableDays)
    {
        ...
        throw new Exception(__('errors.refund_time_limit',['refundableDays' => $refundableDays]), 400);
    }
    ...
    public function verifyIsPurchaseProduct($consumer_id, $product_id)
    {
        ...
        if (!$order) {
            throw new Exception(__('errors.refund_eligibile_for_purchased_products'), 400);
        }
    ...
    public function verifyProductRefundable($product_id)
    {
        if (!$this->isProductCanReturn($product_id)) {
            throw new Exception(__('errors.no_refunds_allowed'), 400);
        }
