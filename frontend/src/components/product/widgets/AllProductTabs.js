...
const AllProductTabs = ({setErrors,setTouched, values, setFieldValue, errors, updateId, activeTab, isSubmitting, setActiveTab, touched, hasSubmitted }) => {
    useEffect(() => {
            ...
            {values.product_type == "physical" &&
                <TabContent activeTab={activeTab}>
                    ...
                    {values.type == "classified" &&
                        <TabPane tabId="4">
                            <VariationsTab hasSubmitted={hasSubmitted} values={values} setFieldValue={setFieldValue} errors={errors} updateId={updateId} />
                        </TabPane>
                    }
