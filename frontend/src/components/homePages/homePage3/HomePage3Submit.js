...
const HomePage3Submit = (values, mutate) => {
    ...
    if (values['homeBannerSubBannerImage']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerSubBannerImage'].hasOwnProperty('asset_url') ? values['homeBannerSubBannerImage'].asset_url : values['homeBannerSubBannerImage']?.original_url
    ...
    values['content']['product_bundles']['bundles'].forEach((elem, i) => {
        if (values[`productBundleImage${i}`]) {
            values['content']['product_bundles']['bundles'][i]['image_url'] = values[`productBundleImage${i}`].hasOwnProperty('asset_url') ? values[`productBundleImage${i}`].asset_url : values[`productBundleImage${i}`]?.original_url
