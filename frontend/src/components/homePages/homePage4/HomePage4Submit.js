...
const HomePage4Submit = (values, mutate) => {
    ...
    if (values['homeBannerBackgroungImage']) {
        values['content']['home_banner']['bg_image_url'] = values['homeBannerBackgroungImage'].hasOwnProperty('asset_url') ? values['homeBannerBackgroungImage']?.asset_url : values['homeBannerBackgroungImage']?.original_url
    ...
    if (values['homeBannerSub1Image']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerSub1Image'].hasOwnProperty('asset_url') ? values['homeBannerSub1Image']?.asset_url : values['homeBannerSub1Image']?.original_url
    } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

    if (values['homeBannerSub2Image']) {
        values['content']['home_banner']['sub_banner_2']['image_url'] = values['homeBannerSub2Image'].hasOwnProperty('asset_url') ? values['homeBannerSub2Image']?.asset_url : values['homeBannerSub2Image']?.original_url
    } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

    if (values['homeBannerSub3Image']) {
        values['content']['home_banner']['sub_banner_3']['image_url'] = values['homeBannerSub3Image'].hasOwnProperty('asset_url') ? values['homeBannerSub3Image']?.asset_url : values['homeBannerSub3Image']?.original_url
    ...
    values['content']['value_banners']['banners'].forEach((elem, i) => {
        if(!values['content']['value_banners']['banners'][i]['redirect_link']) {
            values['content']['value_banners']['banners'][i]['redirect_link'] = {};
        }
        if (values[`featureBannerImage${i}`]) {
            values['content']['value_banners']['banners'][i]['image_url'] = values[`featureBannerImage${i}`].hasOwnProperty('asset_url') ? values[`featureBannerImage${i}`]?.asset_url : values[`featureBannerImage${i}`]?.original_url
