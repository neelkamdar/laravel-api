...
const SettingProvider = (props) => {
  ...
  const { data, isLoading, refetch } = useQuery({queryKey: [SettingAPI], queryFn: () => request({ url: SettingAPI }, router), enabled: false, refetchOnWindowFocus: false, select: (res) => res?.data?.values });
