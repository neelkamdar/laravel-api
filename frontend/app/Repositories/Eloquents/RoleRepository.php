...
class RoleRepository extends BaseRepository
{
    ...
    public function show($id)
    {
        try {
            ...
            return $this->model->with('permissions')->findOrFail($id)?->toArray();
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            if ($role->system_reserve) {
                throw new Exception(__('errors.reserved_role_not_changed'),400);
            }
    ...
    public function destroy($id)
    {
        try {
            ...
            $role = $this->model->findOrFail($id);
            if ($role->system_reserve) {
                throw new Exception(__('errors.reserved_role_not_delete'),400);
            }
