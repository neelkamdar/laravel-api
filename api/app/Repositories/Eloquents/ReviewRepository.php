            ...
            foreach($orders as $order) {
                if ($order) {
                    if (Helpers::isOrderCompleted($order)) {
                        ...
                        throw new Exception(__('errors.review_already_submitted'), 400);
                    }

                    throw new Exception(__('errors.review_possible'), 400);
                }
            }

            throw new Exception(__('errors.before_review_purchase_product'), 400);
