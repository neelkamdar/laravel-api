const HomePage1InitialValue = (data) => {
    ...
    return {
        ...
        section8_VegetableImage: data?.content?.main_content?.section8_full_width_banner?.image_url ? { original_url: data?.content?.main_content?.section8_full_width_banner?.image_url } : "",
