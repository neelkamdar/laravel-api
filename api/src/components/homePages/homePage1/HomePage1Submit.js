...
const HomePage1Submit = (values, mutate) => {
    ...
    if (values['homeBannerMainImage']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeBannerMainImage'].hasOwnProperty('asset_url') ? values['homeBannerMainImage'].asset_url : values['homeBannerMainImage']?.original_url
    } else values['content']['home_banner']['main_banner']['image_url'] = ''

    if (values['homeBannerSubBanner1Image']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerSubBanner1Image'].hasOwnProperty('asset_url') ? values['homeBannerSubBanner1Image'].asset_url : values['homeBannerSubBanner1Image']?.original_url
    } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

    if (values['homeBannerSubBanner2Image']) {
        values['content']['home_banner']['sub_banner_2']['image_url'] = values['homeBannerSubBanner2Image'].hasOwnProperty('asset_url') ? values['homeBannerSubBanner2Image'].asset_url : values['homeBannerSubBanner2Image']?.original_url
    } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

    if (values['mainLeftBanner1']) {
        values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['image_url'] = values['mainLeftBanner1'].hasOwnProperty('asset_url') ? values['mainLeftBanner1'].asset_url : values['mainLeftBanner1']?.original_url
    } else values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['image_url'] = ''

    if (values['mainLeftBanner2']) {
        values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['image_url'] = values['mainLeftBanner2'].hasOwnProperty('asset_url') ? values['mainLeftBanner2'].asset_url : values['mainLeftBanner2']?.original_url
    } else values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['image_url'] = ''

    if (values['section2CategoryImage']) {
        values['content']['main_content']['section2_categories_list']['image_url'] = values['section2CategoryImage'].hasOwnProperty('asset_url') ? values['section2CategoryImage'].asset_url : values['section2CategoryImage']?.original_url
    } else values['content']['main_content']['section2_categories_list']['image_url'] = ''

    if (values['section3Banner1']) {
        values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = values['section3Banner1'].hasOwnProperty('asset_url') ? values['section3Banner1'].asset_url : values['section3Banner1']?.original_url
    } else values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = ''

    if (values['section3Banner2']) {
        values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] = values['section3Banner2'].hasOwnProperty('asset_url') ? values['section3Banner2'].asset_url : values['section3Banner2']?.original_url
    } else values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] = ''

    if (values['section5CouponsImage']) {
        values['content']['main_content']['section5_coupons']['image_url'] = values['section5CouponsImage'].hasOwnProperty('asset_url') ? values['section5CouponsImage'].asset_url : values['section5CouponsImage']?.original_url
    } else values['content']['main_content']['section5_coupons']['image_url'] = ''

    if (values['section6_twocolumnBanner1']) {
        values['content']['main_content']['section6_two_column_banners']['banner_1']['image_url'] = values['section6_twocolumnBanner1'].hasOwnProperty('asset_url') ? values['section6_twocolumnBanner1'].asset_url : values['section6_twocolumnBanner1']?.original_url
    } else values['content']['main_content']['section6_two_column_banners']['banner_1']['image_url'] = ''

    if (values['section6_twocolumnBanner2']) {
        values['content']['main_content']['section6_two_column_banners']['banner_2']['image_url'] = values['section6_twocolumnBanner2'].hasOwnProperty('asset_url') ? values['section6_twocolumnBanner2'].asset_url : values['section6_twocolumnBanner2']?.original_url
    } else values['content']['main_content']['section6_two_column_banners']['banner_2']['image_url'] = ''

    if (values['section8_VegetableImage']) {
        values['content']['main_content']['section8_full_width_banner']['image_url'] = values['section8_VegetableImage'].hasOwnProperty('asset_url') ? values['section8_VegetableImage'].asset_url : values['section8_VegetableImage']?.original_url
    } else values['content']['main_content']['section8_full_width_banner']['image_url'] = ''

    if (values['mainContentSidebarCategoryImage']) {
        values['content']['main_content']['sidebar']['categories_icon_list']['image_url'] = values['mainContentSidebarCategoryImage'].hasOwnProperty('asset_url') ? values['mainContentSidebarCategoryImage'].asset_url : values['mainContentSidebarCategoryImage']?.original_url
    } else values['content']['main_content']['sidebar']['categories_icon_list']['image_url'] = ''

    if (values['newsLetterImage']) {
        values['content']['news_letter']['image_url'] = values['newsLetterImage'].hasOwnProperty('asset_url') ? values['newsLetterImage'].asset_url : values['newsLetterImage']?.original_url
    ...
    values['content']['featured_banners']['banners'].forEach((elem, i) => {
        if (values[`featureBannerImage${i}`]) {
            values['content']['featured_banners']['banners'][i]['image_url'] = values[`featureBannerImage${i}`].hasOwnProperty('asset_url') ? values[`featureBannerImage${i}`].asset_url : values[`featureBannerImage${i}`]?.original_url
        } else {
            values['content']['featured_banners']['banners'][i]['image_url'] = ''
        }
        if(!values['content']['featured_banners']['banners'][i]['redirect_link']) {
            values['content']['featured_banners']['banners'][i]['redirect_link'] = {}
        }
