        ...
        <>
            {values['isPoint']?.balance > 0 && data?.data?.total?.convert_point_amount && <>
                ...
                <li className='border-cls'>
                    <Label className='form-check-label m-0'>{t("would_you_prefer_to_pay_using_points")}?</Label>
            ...
            {values['isWallet']?.balance > 0 && data?.data?.total?.convert_wallet_balance && <>
                ...
                <li className='border-cls'>
                    <Label className='form-check-label m-0'>{t("would_you_prefer_to_pay_using_wallet")}?</Label>
