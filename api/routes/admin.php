...
Route::group(['middleware' => ['localization']], function () {
  ...
  // Countries & States
  Route::apiResource('state', 'App\Http\Controllers\StateController')->only(['index', 'show'])->names([
    'index' => 'admin.states.index',
    'show' => 'admin.states.show'
  ]);

  Route::apiResource('country', 'App\Http\Controllers\CountryController')->only(['index', 'show'])->names([
  ...
  Route::post('/forgot-password', 'App\Http\Controllers\AuthController@backendForgotPassword');
