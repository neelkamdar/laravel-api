...
const POS = () => {
  ...
  const { data: CategoryData, isLoading } = useQuery({ queryKey: [Category], queryFn: () => request({ url: Category, params: { type: 'product', status: 1 } },router), refetchOnWindowFocus: false, select: (data) => data.data.data });
