...
import { HomePage3SetttingTitle } from "../../../data/TabTitleList";
...
const HomePageThreeForm = ({ title }) => {
    ...
    const { data, isLoading } = useQuery({ queryKey: [HomePageAPI], queryFn: () => request({ url: HomePageAPI, params: { slug: 'osaka' } }, router),
                ...
                <Col>
                    <Card>
                        ...
                        <Form className="theme-form theme-form-2 mega-form vertical-tabs">
                            <LanguageRedirection theme={'/theme'} path={'osaka'} />
                            <Row>
                                <Col xl="3" lg="4">
