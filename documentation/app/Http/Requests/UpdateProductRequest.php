...
class UpdateProductRequest extends FormRequest
{
        ...
        if (isset($this->related_products)) {
            foreach ($this->related_products as $related_product) {
                if ($id == $related_product) {
                    throw new ExceptionHandler(__('errors.related_product_already_taken'), 400);
                }
            }
        }
    ...
    {
        return [
            'discount.regex' => __('validation.discount_between'),
            'type.in' => __('validation.product_simple_classified'),
            'license_type.in' => __('validation.license_type'),
            'stock_status.in' => __('validation.stock_status'),
            'video_provider.in' => __('validation.video_provider'),
            'watermark_position.required_if' => __('validation.position_required'),
            'variations.*.sku.unique' => __('validation.sku_already_taken'),
            'variations.*.discount.regex' => __('validation.variation_between_input'),
            'variations.*.stock_status.in' => __('validation.variations_stock_status'),
            'variations.*.is_licensable.required_if' => __('validation.is_licensable_required'),
            'variations.*.is_licensekey_auto.required_if' => __('validation.is_licensekey_auto_required'),
            'variations.*.separator.required_if' => __('validation.variation_separator_required'),
            'variations.*.license_key.required_if' => __('validation.license_key_required'),
        ];
    }
