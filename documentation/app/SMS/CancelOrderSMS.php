      ...
      public function getMessage($roleName, $order)
      {
            switch($roleName) {
                  case RoleEnum::CONSUMER:
                        return __('sms.cancel_order_consumer_sms',['orderNumber' => $order->order_number]);
                  case RoleEnum::VENDOR:
                        return __('sms.cancel_order_vendor_sms',['orderNumber' => $order->order_number]);
                  case RoleEnum::ADMIN:
                        return __('sms.cancel_order_admin_sms',['orderNumber' => $order->order_number]);
            }
      }
